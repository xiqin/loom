...
- **宪章**：`.rss/constitution.md`（由 `/rss-init-project` 自动生成）
- **工程约束**：`.rss/project-structure.md`（由 `/rss-init-project` 自动生成）
...
**融合说明：** rss 继承 superpowers 并融合两者优点，包含流程图、自检清单、反模式、常见误区等增强特性。
...
| using-rss | rss 框架使用指南（含常见问题、流程图） |
